...
3. Each layer saves its rotated keys and values into the cache. The final norm and projection produce logits. Greedy selection takes the highest-scoring token at the last prompt position.
