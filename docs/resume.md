...
**LLM Inference Engine** · Python, PyTorch, CUDA, Apple MPS

[github.com/gpack2/inference-engine](https://github.com/gpack2/inference-engine)

- Built a Qwen2.5-0.5B inference runtime with a custom decoder, preallocated KV cache, and greedy generation; validated numerical behavior with 30 tests and CPU/MPS/CUDA checks against Hugging Face Transformers.
...
[KV-cache measurements](../results/qwen-mps-generation-smoke.json) · [Projection study](performance-measurement.md) · [Validation](pretrained.md) · [NVIDIA validation](nvidia.md)
